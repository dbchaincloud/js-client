...
async function getFeildType(appCode, tableName, fieldName){
...
export { getFriends, getPendingFriends, getAppCode, getApps, getApp, isAppUser, isSysAdmin, checkChainId,
         ...
         uploadFile, addFriend, dropFriend, respondFriend, commit, querier, callFunction ,callCustomQuerier, getFeildType
};
